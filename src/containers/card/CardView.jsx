  ...
  return (
    ...
    <div className="row mb-5">
      <div className="col-md-6 col-lg-4 mb-3">
        <div className="card h-100">
          <img className="card-img-top" src="/src/assets/img/elements/2.jpg" alt="Card image cap" />
      ...
      <div className="col-md-6 col-lg-4 mb-3">
        <div className="card h-100">
          ...
          <img className="img-fluid" src="/src/assets/img/elements/13.jpg" alt="Card image cap" />
          <div className="card-body">
        ...
        <div className="card h-100">
          <div className="card-body">
            ...
            <img
              ...
              src="/src/assets/img/elements/4.jpg"
              alt="Card image cap"
            />
            <p className="card-text">Bear claw sesame snaps gummies chocolate.</p>
            <a href="" className="card-link">Card link</a>
    ...
    <div className="row mb-5">
      ...
      <div className="col-md-6 col-lg-4">
        ...
        <div className="card mb-4">
          <img className="card-img-top" src="/src/assets/img/elements/5.jpg" alt="Card image cap" />
          <div className="card-body">
            <p className="card-text">
              Some quick example text to build on the card title and make up the bulk of the card's content.
            </p>
      ...
      <div className="col-md-6 col-lg-4">
        ...
        <div className="card">
          <img className="card-img-top" src="/src/assets/img/elements/7.jpg" alt="Card image cap" />
          <div className="card-body">
            <h5 className="card-title">Card title</h5>
    ...
    <div className="row mb-5">
      <div className="col-md-6 col-xl-4">
        <div className="card mb-3">
          <img className="card-img-top" src="/src/assets/img/elements/18.jpg" alt="Card image cap" />
          <div className="card-body">
            <h5 className="card-title">Card title</h5>
            <p className="card-text">
      ...
      <div className="col-md-6 col-xl-4">
        <div className="card mb-3">
          ...
          <img className="card-img-bottom" src="/src/assets/img/elements/1.jpg" alt="Card image cap" />
        </div>
      </div>
      <div className="col-md-6 col-xl-4">
        <div className="card bg-dark border-0 text-white">
          <img className="card-img" src="/src/assets/img/elements/11.jpg" alt="Card image" />
        ...
        <div className="card mb-3">
          <div className="row g-0">
            <div className="col-md-4">
              <img className="card-img card-img-left" src="/src/assets/img/elements/12.jpg" alt="Card image" />
            </div>
    ...
    <div className="card-group mb-5">
      <div className="card">
        <img className="card-img-top" src="/src/assets/img/elements/4.jpg" alt="Card image cap" />
        <div className="card-body">
          <h5 className="card-title">Card title</h5>
          <p className="card-text">
            This is a wider card with supporting text below as a natural lead-in to additional content. This
      ...
      <div className="card">
        <img className="card-img-top" src="/src/assets/img/elements/1.jpg" alt="Card image cap" />
        <div className="card-body">
          <h5 className="card-title">Card title</h5>
          <p className="card-text">
            This is a wider card with supporting text below as a natural lead-in to additional content. This
    ...
    <div className="row row-cols-1 row-cols-md-3 g-4 mb-5">
      ...
      <div className="col">
        <div className="card h-100">
          <img className="card-img-top" src="/src/assets/img/elements/13.jpg" alt="Card image cap" />
          <div className="card-body">
            <h5 className="card-title">Card title</h5>
            <p className="card-text">
              This is a longer card with supporting text below as a natural lead-in to additional content.
      ...
      <div className="col">
        <div className="card h-100">
          <img className="card-img-top" src="/src/assets/img/elements/19.jpg" alt="Card image cap" />
          <div className="card-body">
            <h5 className="card-title">Card title</h5>
            <p className="card-text">
              This is a longer card with supporting text below as a natural lead-in to additional content.
      ...
      <div className="col">
        <div className="card h-100">
          <img className="card-img-top" src="/src/assets/img/elements/20.jpg" alt="Card image cap" />
          <div className="card-body">
            <h5 className="card-title">Card title</h5>
            <p className="card-text">
              This is a longer card with supporting text below as a natural lead-in to additional content.
