...
function Menu() {
  const [isLoadLayout, setIsLoadLayout] = useState(false);
  const [isLoadDashBorad, setIsLoadDashBorad] = useState(false);
  ...
  return (
    <aside
      ...
      className="menu-vertical menu bg-menu-theme box-menu"
      style={mystyle}
      // data-bg-class="bg-menu-theme"
    >
      <div className="app-brand demo">
        <Link to={"/dashborad"} className="app-brand-link">
      ...
      <PerfectScrollbar>
        <ul className="menu-inner py-1">
          <li className="menu-item active">
            <Link to={"/dashborad"} className="menu-link">
              <i className="menu-icon tf-icons bx bx-home-circle"></i>
              <div data-i18n="Analytics">Dashboard</div>
            </Link>
          </li>

          <li className={`menu-item ${isLoadLayout && "open active"}`}>
            <a
              className="menu-link menu-toggle cursor"
              onClick={() => setIsLoadLayout(!isLoadLayout)}
            >
